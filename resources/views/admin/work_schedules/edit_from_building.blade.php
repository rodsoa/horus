        ...
        <div class="tab-content" id="nav-tabContent">         
            ...
            <div class="tab-pane fade" id="nav-{{ $value }}" role="tabpanel" aria-labelledby="nav-{{ $value }}-tab">
                <div class="card custom card-body">     
                    <form action="{{ action('Admin\WorkSchedulesController@updateFromBuilding', ['id' => $building->id]) }}">
                        {{ csrf_field() }}
                        ...
                        @endforeach
                        <br />
                        <a role="button" class="btn btn-danger" href="{{ action('Admin\BuildingsController@view', ['id' => $building->id]) }}">Cancelar</a>

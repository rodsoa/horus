...
<form id="needs-validation" action="{{ action('Admin\EmployeesController@update', ['matricula' => $employee->registration_number]) }}" method="POST" enctype="multipart/form-data" novalidate>
    {{ csrf_field() }}
    <div class="form-row">
    ...
    <a class="btn btn-danger" role="button" href="{{ action('Admin\EmployeesController@index') }}">Cancelar</a>

...
<form action="{{ action('WorkSchedulesController@addFromBuilding', ['id' => $building->id]) }}" method="POST">
    {{ csrf_field() }}
    ...
    <a class="btn btn-danger" role="button" href="{{ action('BuildingsController@view', ['id' => $building->id]) }}">Cancelar</a>

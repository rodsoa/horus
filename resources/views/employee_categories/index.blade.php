...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12 col-md-6 col-lg-6">
            <a role="button" class="btn btn-primary" href="{{ action('EmployeeCategoriesController@new') }}">
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                <a role="button" class="btn btn-secondary" href="{{ action('EmployeeCategoriesController@edit', ['id' => $category->id ]) }}"><i class="fa fa-pencil"></i> editar</a>
                            </div>
                            <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                <form method="POST" action="{{ action('EmployeeCategoriesController@delete', ['id' => $category->id]) }}">
                                    {{ csrf_field () }}
